package com.viktoriagavrosh.englishsimulator.ui.horizontal.menu.translatemenu
...
class HorizontalTranslateMenuScreenTest {
    @get:Rule
    ...
    @Test
    fun translateMenuScreen_horizontal_addButtonIsNotDisplayed() {
        setMenuScreen()
    ...
    @Test
    fun translateMenuScreen_horizontal_dropdownMenuIsNotDisplayed() {
        setMenuScreen()
