package com.viktoriagavrosh.englishsimulator.ui.horizontal.game.wordgame
...
class HorizontalWordGameScreenTest {

    @get:Rule
    val composeTestRule = createAndroidComposeRule<ComponentActivity>()

    @Test
    fun wordGameScreen_horizontal_backButtonIsDisplayed() {
        setGameScreen()
    ...
    @Test
    fun wordGameScreen_horizontal_editButtonIsDisplayed() {
        setGameScreen()
    ...
    @Test
    fun wordGameScreen_horizontal_scoreBoxIsDisplayed() {
        val score = 54
    ...
    @Test
    fun wordGameScreen_horizontal_questionTextIsDisplayed() {
    ...
    @Test
    fun wordGameScreen_horizontal_cardForTranslateTextIsDisplayed() {
        setGameScreen()
    ...
    @Test
    fun wordGameScreen_horizontal_translateTextIsDisplayed() {
        val gameQuestion = FakeSource.fakeGameQuestion[0]
        setGameScreen(gameQuestion = gameQuestion)
        composeTestRule.onNodeWithContentDescriptionById(R.string.answer)
            .performClick()
    ...
    @Test
    fun wordGameScreen_horizontal_nextButtonIsDisplayed() {
        setGameScreen()
