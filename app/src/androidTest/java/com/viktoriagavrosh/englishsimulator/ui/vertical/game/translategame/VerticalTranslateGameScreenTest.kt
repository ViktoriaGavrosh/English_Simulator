package com.viktoriagavrosh.englishsimulator.ui.vertical.game.translategame
...
class VerticalTranslateGameScreenTest {

    @get:Rule
    val composeTestRule = createAndroidComposeRule<ComponentActivity>()

    @Test
    fun translateGameScreen_vertical_backButtonIsDisplayed() {
        setGameScreen()
    ...
    @Test
    fun translateGameScreen_vertical_editButtonIsNotDisplayed() {
        setGameScreen()
    ...
    @Test
    fun translateGameScreen_vertical_scoreBoxIsDisplayed() {
        val score = 54
    ...
    @Test
    fun translateGameScreen_vertical_questionTextIsDisplayed() {
    ...
    @Test
    fun translateGameScreen_vertical_cardForTranslateTextIsDisplayed() {
        setGameScreen()
    ...
    @Test
    fun translateGameScreen_vertical_translateTextIsDisplayed() {
        val gameQuestion = FakeSource.fakeGameQuestion[0]
        setGameScreen(gameQuestion = gameQuestion)
        composeTestRule.onNodeWithContentDescriptionById(R.string.answer)
            .performClick()
    ...
    @Test
    fun translateGameScreen_vertical_nextButtonIsDisplayed() {
        setGameScreen()
