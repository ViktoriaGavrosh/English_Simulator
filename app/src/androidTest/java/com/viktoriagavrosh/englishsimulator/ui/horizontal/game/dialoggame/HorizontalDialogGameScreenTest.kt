package com.viktoriagavrosh.englishsimulator.ui.horizontal.game.dialoggame
...
class HorizontalDialogGameScreenTest {

    @get:Rule
    val composeTestRule = createAndroidComposeRule<ComponentActivity>()

    @Test
    fun dialogGameScreen_horizontal_backButtonIsDisplayed() {
        setGameScreen()
    ...
    @Test
    fun dialogGameScreen_horizontal_editButtonIsNotDisplayed() {
        setGameScreen()
    ...
    @Test
    fun dialogGameScreen_horizontal_scoreBoxIsDisplayed() {
        val score = 54
    ...
    @Test
    fun dialogGameScreen_horizontal_questionTextIsDisplayed() {
    ...
    @Test
    fun dialogGameScreen_horizontal_cardForTranslateTextIsDisplayed() {
        setGameScreen()
    ...
    @Test
    fun dialogGameScreen_horizontal_translateTextIsDisplayed() {
        val gameQuestion = FakeSource.fakeGameQuestion[0]
        setGameScreen(gameQuestion = gameQuestion)
        composeTestRule.onNodeWithContentDescriptionById(R.string.answer)
            .performClick()
    ...
    @Test
    fun dialogGameScreen_horizontal_nextButtonIsDisplayed() {
        setGameScreen()
