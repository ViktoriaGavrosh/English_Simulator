package com.viktoriagavrosh.englishsimulator.ui.horizontal.menu.wordmenu
...
class HorizontalWordMenuScreenTest {
    @get:Rule
    val composeTestRule = createAndroidComposeRule<ComponentActivity>()

    @Test
    fun wordMenuScreen_horizontal_titleIsDisplayed() {
        setMenuScreen()
        composeTestRule.onNodeWithTextById(R.string.word_horizontal_title)
            .assertExists("No title on WordMenuScreen")
            .assertIsDisplayed()
    }

    @Test
    fun wordMenuScreen_horizontal_backButtonIsDisplayed() {
        setMenuScreen()
    ...
    @Test
    fun wordMenuScreen_horizontal_addButtonIsDisplayed() {
        setMenuScreen()
    ...
    @Test
    fun wordMenuScreen_horizontal_allThemeCardIsDisplayed() {
        setMenuScreen()
    ...
    @Test
    fun wordMenuScreen_horizontal_customCardsIsDisplayed() {
    ...
    @Test
    fun wordMenuScreen_horizontal_dropdownMenuIsDisplayed() {
        setMenuScreen()
