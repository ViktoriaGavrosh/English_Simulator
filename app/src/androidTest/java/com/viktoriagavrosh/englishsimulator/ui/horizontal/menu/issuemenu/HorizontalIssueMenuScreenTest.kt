package com.viktoriagavrosh.englishsimulator.ui.horizontal.menu.issuemenu
...
class HorizontalIssueMenuScreenTest {
    @get:Rule
    ...
    @Test
    fun issueMenuScreen_horizontal_addButtonIsNotDisplayed() {
        setMenuScreen()
    ...
    @Test
    fun issueMenuScreen_horizontal_dropdownMenuIsNotDisplayed() {
        setMenuScreen()
